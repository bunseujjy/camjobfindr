...
import { createJob } from "@/features/job/actions/job";
...
const NewJob = ({ companies, userId }: NewJobProps) => {
  ...
  const onSubmit = async (data: JobFormValues) => {
    try {
      ...
      await createJob({ ...data, experience: data.experience + " " + "Year+" });
      ...
      toast.error("There was a problem posting your job.");
    } finally {
